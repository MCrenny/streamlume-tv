...
// Плейлисты теперь раздаются с нашего же домена (streamlume-tv.netlify.app/playlists/*.m3u).
// Файлы скачиваются раз в сутки GitHub Action'ом (.github/workflows/update-playlists.yml)
...
const styles = StyleSheet.create({
  ...
  portalBadge: { backgroundColor: 'rgba(10, 132, 255, 0.15)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(10, 132, 255, 0.4)', marginLeft: 8 },
  portalBadgeText: { color: '#0A84FF', fontSize: 11, fontWeight: '600' },
