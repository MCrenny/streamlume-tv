...
export async function runAutoblog(appType) {
  ...
  if (appType === 'iptv') {
    ...
    prompt = `
      ...
      В конце поста ОБЯЗАТЕЛЬНО добавь призыв перейти в наш Telegram-бот @StreameLumeBot за бесплатным триалом на 3 дня.
      Также ОБЯЗАТЕЛЬНО добавь инструкцию: "Для настройки на Smart TV скачайте бесплатное приложение Media Station X и в настройках Start Parameter укажите адрес: streamlume-tv-svmorozoww.amvera.io"
